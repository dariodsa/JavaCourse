...
public class CatCommand implements ShellCommand {
	...
	public ShellStatus executeCommand(Environment env, String arguments) {
		...
		Path path = Paths.get(env.getCurrentDirectory().toString(), sep[0]);
		Charset charSet;
	 ...
	 *             file is not found
	 */
	private void writeFile(Path path, Charset charSet, Environment env) throws IOException {
