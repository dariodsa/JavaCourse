...
/**
 * Class {@link ConnectionSetterFilter} implemnets {@link Filter} which
 * responsibility is to initialize all necessary threads and connection for
 * users to access to the web.
 * 
 * @author dario
 *
 */
