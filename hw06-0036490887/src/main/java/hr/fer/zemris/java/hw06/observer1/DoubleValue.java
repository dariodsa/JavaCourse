...
public class DoubleValue implements IntegerStorageObserver {
	...
	/**
	 * Constructs {@link SquareValue} with the number of modifications that are
	 * tracked by this object. When the observed object modifies more then n times,
	 * this observer will automatically unregister.
	 * 
	 * @param modificationCount
	 *            number of modifications that are tracked by this observer
	 */
